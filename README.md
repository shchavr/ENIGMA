...
5.  **👨‍💻 Проверка оператором:** Оператор видит новую запись, проверяет извлеченные данные и сгенерированный ответ, при необходимости редактирует его.
6.  **✅ Отправка:** Оператор отправляет финальный ответ клиенту.
7.  **💾 Сохранение:** История обращения сохраняется в БД для аналитики.

> **Ссылка на User Flow:** `[Вставьте ссылку на ваш Miro/Figma здесь]`

---

## ⚙️ Логика работы AI-агента
...
> **🔗 Ссылка на ER-диаграмму:** [Вставьте ссылку на изображение ER-диаграммы или файл .drawio здесь]
